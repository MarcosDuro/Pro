...
async def my_event_handler(m):
    ...
    text = f"""
<b><i> Scrapper - Tilin [Massive CCS]</i></b>
[#Bin{cc[:6]}]
<b>• Card Details:</b>
<b>- CC</b><code> [{cc}|{mes}|{ano}|{cvv}]</code>
<b>- Extra</b><code> [{hidden_card_number2(cc)}|{mes}|{ano}|rnd</code>]
<b>• Bin Details:</b>
<b>- Bank</b> [{bank}]
<b>- Info</b> [<code>{cc[:6]}</code>] [{level} - {card_type} - {brand}]
<b>- Country</b> [{country_name} ({country_flag}) ]
<b>- Owner</b> <a href="tg://resolve?domain=BannedEnd"></a>
"""    
